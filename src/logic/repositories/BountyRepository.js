...
export default class BountyRepository {
    static all() {
        return axios.get(process.env.REACT_APP_BACKEND_URL+'/api/v1/bounty', SessionManager.config)
            .then((response) => {
    ...
    static get(bountyId) {
        return axios.get(process.env.REACT_APP_BACKEND_URL+'/api/v1/bounty/'+bountyId, SessionManager.config)
            .then((response) => {
    ...
    static getStatus(bountyId) {
        return axios.get(process.env.REACT_APP_BACKEND_URL+'/api/v1/bounty/'+bountyId+'/status', SessionManager.config)
            .then((response) => {
