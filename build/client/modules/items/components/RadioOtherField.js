...
function (_React$Component) {
  _inherits(RadioOtherField, _React$Component);

  function RadioOtherField(props) {
    var _this;

    _classCallCheck(this, RadioOtherField);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(RadioOtherField).call(this, props));
    _this.state = {
      otherSelected: false
    };
  ...
  _createClass(RadioOtherField, [{
    ...
    value: function render() {
      ...
      options.push(_react["default"].createElement(_RadioOtherElement["default"], {
        key: "other",
        className: "small",
  ...
  return RadioOtherField;
}(_react["default"].Component);

exports["default"] = RadioOtherField;