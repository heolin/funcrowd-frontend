...
function (_React$Component) {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      ...
      var width = this.props.value.width || 250;
      var progress = this.props.value.progress;
      ...
      return _react["default"].createElement("div", {
        ...
        className: "progress bg-light-blue height-12",
        style: {
          width: width + "px",
          margin: "auto"
        }
      }, _react["default"].createElement("div", {
        className: "progress-bar bg-blue height-12",
        style: {
          width: progress + "%"
        }
      })), _react["default"].createElement("div", {
