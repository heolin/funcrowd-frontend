...
var CheckboxOtherElement =
/*#__PURE__*/
function (_React$Component) {
  _inherits(CheckboxOtherElement, _React$Component);

  function CheckboxOtherElement(props) {
    var _this;

    _classCallCheck(this, CheckboxOtherElement);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CheckboxOtherElement).call(this, props));
    _this.state = {
      value: ""
    };
  ...
  _createClass(CheckboxOtherElement, [{
    key: "handleChange",
  ...
  return CheckboxOtherElement;
}(_react["default"].Component);

exports["default"] = CheckboxOtherElement;