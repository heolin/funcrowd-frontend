...
var ClassificationFeedbackModal =
/*#__PURE__*/
function (_React$Component) {
  _inherits(ClassificationFeedbackModal, _React$Component);

  /*
  Requires ReferenceScore feedback
   */
  function ClassificationFeedbackModal(props) {
    var _this;

    _classCallCheck(this, ClassificationFeedbackModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ClassificationFeedbackModal).call(this, props));
    _this.state = {
      feedback: null
    };
    return _this;
  ...
  _createClass(ClassificationFeedbackModal, [{
    key: "render",
    value: function render() {
      ...
      if (score >= 0.5) {
        ...
        message = _react["default"].createElement("div", null, _react["default"].createElement("p", null, _LocalizationManager["default"].feedback.annotationCorrectMessage), _react["default"].createElement("p", null, "Correct answer: ", _react["default"].createElement("span", {
          className: "color-green"
        }, reference)));
      }
  ...
  return ClassificationFeedbackModal;
}(_react["default"].Component);

exports["default"] = ClassificationFeedbackModal;