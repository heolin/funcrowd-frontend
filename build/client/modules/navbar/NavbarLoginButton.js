...
function (_React$Component) {
  ...
  function NavbarLoginButton() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(NavbarLoginButton).apply(this, arguments));
  }

  _createClass(NavbarLoginButton, [{
    key: "render",
    value: function render() {
      var className = "btn-orange-primary";
      if (this.props.isSelected) className = "btn-orange";
